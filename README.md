...
This is FullStack application, based on the consumption of the data provided by the public Stars Wars API ([`swapi.info`](https://swapi.info/)) since the original requested was not present ([`swapi.dev`](https://swapi.dev/)) 
